        ...
        unsafe {
            match self.config {
                ...
                TextureConfig::Cube {
                    ...
                    return Err(TextureError::NotSupportResize);
                }
            }
    ...
    fn apply_config(config: TextureConfig) {
        match config {
            TextureConfig::Common {
                ...
                set_wrap(gl::TEXTURE_WRAP_S, wrapping_s);
                set_wrap(gl::TEXTURE_WRAP_T, wrapping_t);
            ...
            TextureConfig::Cube {
                ...
                set_wrap(gl::TEXTURE_WRAP_T, wrapping_t);
                // 立方体贴图还需要设置 R 方向
                set_wrap(gl::TEXTURE_WRAP_R, wrapping_s); // 通常使用相同的包裹模式
